...
Geomeary::Geomeary(QWidget *parent)
    : QDialog(parent)
...
void Geomeary::moveEvent(QMoveEvent*){
    updateLabel();
}


void Geomeary::resizeEvent(QResizeEvent*){
    updateLabel();
}
